...
<div class='container' style='overflow-y:scroll;height: 100%;margin-top:100px;'>
    ...
    <div style='position:relative;'>
        ...
        <p style="text-shadow: 3px 4px 8px black; width: 20px; height: 20px;border-radius: 50%;position:absolute; top:10px; left:50px;color:white;font-weight:bold;z-index:777">$programmerprod</p>
